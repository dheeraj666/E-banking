...
<script language="JavaScript" src="scripts/gen_validatorv31.js" type="text/javascript"></script>
  ...
  <body>
   ...
   <table align="center"><tr><td><a href="./Name.jsp"><input type="button" value="Name" id="name" onclick="invoke();"></a></td><td><a href="./Phone.jsp"><input type="button" value="Phone" id="phone" onclick="phone();"></a></td><td><a href="./SearchCustomer.jsp"><input type="button" value="AccountNumber" id="accno" onclick="accno();"></a></td></tr></table>
  
  <form action="./SearchUserByPhone" name="search">
  
  <table bgcolor="#66CC33" align="center">
  <tr><td>EnterPhoneNo<input type="text" name="phone">
