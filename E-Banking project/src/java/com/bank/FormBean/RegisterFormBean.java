...
public class RegisterFormBean  {
	...
	private int urid,accno;
	
	private double accbal;
	private String fax,acctype;
	private String photo,addrproof;
	private String idproof,login,cname,nname;
