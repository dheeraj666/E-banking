...
public class DesEncrypter {
	// public static final Logger log=Logger.getLogger("reusable.DesEncrypter");
	Cipher ecipher;
	...
	public static void main(String arg[]) {
		try {
			...
			System.out.println(encrypter.encrypt("Lakku"));
			System.out.println(encrypter.decrypt("xlWvTx7oje4="));
		} catch (Exception e) {
		}
